...
import Logo from "../public/logo/PACCHAR-negro.png"


const Hero = () => {

    return(
      <div className='flex items-center justify-center h-screen  bg-cover bg-center bg-fixed bg-gradient-to-r from-sky-600 to-green-500'>
            ...
            <div className='p-5 text-[#000000] z-[2] md:ml-[1rem] ml-0 mt-[1rem]'>
              ...
              <Typed
          className='absolute md:text-4xl text-4xl lg:text-4xl  md:pl-4 pl-2'
