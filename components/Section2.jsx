...
const Section2 = () => {
  ...
  >
            <h2 className="m-0 text-xl text-green-600 font-bold leading-tight border-0 border-gray-300 lg:text-3xl md:text-2xl text-center md:text-left">
            Creamos valor a partir de residuos forestales y agropecuarios. 
            </h2>
            </motion.div>
